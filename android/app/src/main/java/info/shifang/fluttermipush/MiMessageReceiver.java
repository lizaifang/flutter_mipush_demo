...
public class MiMessageReceiver extends PushMessageReceiver {
    ...
    public void onReceivePassThroughMessage(Context context, MiPushMessage message) {
        Log.v("", "onReceivePassThroughMessage is called. " + message.toString());
    ...
    public void onNotificationMessageClicked(Context context, MiPushMessage message) {
        Log.v("BaseApplication.TAG", "onNotificationMessageClicked is called. " + message.toString());
    ...
    public void onCommandResult(Context context, MiPushCommandMessage message) {
        Log.v("BaseApplication.TAG", "onCommandResult is called. " + message.toString());
        ...
        if (MiPushClient.COMMAND_REGISTER.equals(command)) {
            if (message.getResultCode() == ErrorCode.SUCCESS) {
                mRegId = cmdArg1;
                Log.v("BaseApplication.TAG", "mRegId: " + mRegId);
                // log = context.getString("R.string.register_success");
            } else {
                // log = context.getString("R.string.register_fail");
                Log.v("BaseApplication.TAG", "register_fail");
            }
    ...
    public void onReceiveRegisterResult(Context context, MiPushCommandMessage message) {
        Log.v("BaseApplication.TAG", "onReceiveRegisterResult is called. " + message.toString());
        String command = message.getCommand();
        List<String> arguments = message.getCommandArguments();
        String cmdArg1 = ((arguments != null && arguments.size() > 0) ? arguments.get(0) : null);
        String log;
